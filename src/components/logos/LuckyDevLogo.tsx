  ...
  return (
    <div className="flex items-center gap-x-2">
      <div className="relative">
        <div className="w-8 aspect-square  bg-gradient-to-tr from-blue-500 to-cyan-500 rounded-lg shadow-lg shadow-blue-500/50 animate-pulse flex items-center justify-center">
